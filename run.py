...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game(name="Напиши {}help".format(config.BOT_PREFIX)))

    for guild in bot.guilds:
        await register(guild)
        print("Присоединился {}".format(guild.name))
